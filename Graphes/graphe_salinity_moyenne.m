...
% Ce programme trace les graphiques représentant les moyennes de salinité
...
% moyenne_salinity_eurasie
% moyenne_salinity_canada
...
eurasie_sci=eurasie_sci*(areaquad(82,0,90,140,earthellipsoid)+areaquad(78,110,82,140,earthellipsoid)+areaquad(82,310,90,360,earthellipsoid)+areaquad(83.5,310,90,360,earthellipsoid)+areaquad(78,141,90,180,earthellipsoid));
eurasie_sci=eurasie_sci/100;
...
ylim([0 2.5e6])
legend([h1,h2],'Salinity','sea ice extent','Location','southeast')
...
yyaxis right
ylabel('sea ice extent (km²)')
h2=plot(x,canada_sci,'linewidth',2,'Color','c')
ylim([0 2.5e6])
legend([h1,h2],'Salinity','sea ice extent','Location','northeast')


print('variabilite_spatiale_Salinity_sci', '-dpng', '-r300')
