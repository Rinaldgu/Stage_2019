...
%Programme calculant les moyennes mensuelles de mld dans le bassin Eurasien
...
for j=1:size(BM,2)
    if BM(10,j)>82 &  BM(10,j)<90 & BM(9,j)>0 & BM(9,j)<140 | BM(10,j)>78 &  BM(10,j)<82 & BM(9,j)>110 & BM(9,j)<140 | BM(10,j)>82 &  BM(10,j)<90 & BM(9,j)>310 & BM(9,j)<360 | BM(10,j)>83.5 &  BM(10,j)<90 & BM(9,j)>310 & BM(9,j)<360 | BM(10,j)>78 &  BM(10,j)<90 & BM(9,j)>141 & BM(9,j)<180
            if BM(3,j)==1
                if BM(6,j)>0
                   e1(j)=BM(6,j); %Salinité
